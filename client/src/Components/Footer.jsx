    ...
    return(
        <div className="Footer">
            ...
            <div className="Footer__socialContainer">
                ...
                <a href="https://open.spotify.com/playlist/6a6WHsODpZRCD4lUwyYVdN?si=1bbcd7e565a24486" target="_blank" rel="noopener noreferer" className="socialContainer__svgLink">
